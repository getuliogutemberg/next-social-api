...
export default function Verified() {
  ...
  useEffect(() => {
    JSON.parse(localStorage.getItem('user')).level === 0 && router.push('/openview');
  },[])
  // useEffect(() => {
  ...
  return (
    ...
    {JSON.parse(localStorage.getItem('user')).level > 0 && <div className="col-span-4 row-span-4   rounded-lg text-center overflow-auto">
      <div className="text-2xl  mb-4 flex flex-1 items-center justify-start">
        <TbMessageShare className='text-[40px] text-purple-800 mx-4'/><h2 className="text-white">Posts secretos</h2></div>
  ...
  return timeB - timeA;
    ...
    {JSON.parse(localStorage.getItem('user')).level > 0 && <div className="row-span-5 col-start-5 bg-white rounded-lg shadow-md text-center h-full  overflow-auto">
...
return (
    ...
    {JSON.parse(localStorage.getItem('user')).level > 0 && <div className="col-span-4 row-start-5 bg-white rounded-lg shadow-md text-center p-4 overflow-auto ">
