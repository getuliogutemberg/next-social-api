...
export default function Home() {
  ...
  return (
      ...
      <div className="flex-1 items-center justify-between flex flex-row max-[1200px]:flex-col gap-10 h-screen bg-slate-900 min-h-screen ">
        ...
        <div>
        <h1 className="text-6xl font-extrabold text-purple-900"><p className="text-green-600">Capyba</p>quígrafo</h1>
        
        <p className="mt-4 text-lg text-gray-600 text-center">Seja bem-vindo</p>
        </div>
        <TfiComments className='text-[100px] text-green-600 m-4 drop-shadow-lg'/>
        
        </div>
        <div className="flex justify-center items-center w-[50%] ">
        <Link href="/login"  className={` flex items-center justify-center gap-2 text-2xl  text-gray-300  hover:text-green-600`}>
